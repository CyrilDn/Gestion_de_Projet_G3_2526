...
class ScriptAvantCourse:
    ...
    def _verifier_moteurs(self):
        ...
        self.controleur.moteur1.avancer(vitesse=80, ramping=True)
        self.controleur.moteur2.avancer(vitesse=80 , ramping=True)
        time.sleep(1)
        print("Test 2.2 : Moteur arrière - Reculer")
        self.controleur.moteur1.reculer(vitesse=80 , ramping=True)
        self.controleur.moteur2.reculer(vitesse=80 , ramping=True)
        time.sleep(1)
    ...
    def _verifier_batterie(self):
        ...
        print(f" 🪫 - Niveau de Tension: {niveau}%")
        print(f" 🪫 - Niveau de Courant: {courant}%")
        time.sleep(0.5)
